    ...
    <main className="container-fluid px-0">
      ...
      <div className="px-xl-5 px-4 auth-header" data-bs-theme="none">
        <Link to="/" className="brand-icon text-decoration-none d-flex align-items-center" title="Networsys Admin Template">
          ...
          <span className="fw-bold ps-2 fs-5 text-gradient">Networsys</span>
        </Link>
      </div>

      {/* Auth Aside */}
      <aside className="px-xl-5 px-4 auth-aside" data-bs-theme="none">
        <img className="login-img" src="/assets/images/login-img.png" alt="" />
      </aside>
        ...
        <form onSubmit={handleSignUp}>
          <ul className="row g-3 list-unstyled li_animate">
            ...
            <li className="col-12">
              <div className="form-check">
                ...
                <label className="form-check-label" htmlFor="TermsConditions">
                  I accept the{' '}
                  <Link to="#" title="" className="text-primary">
            ...
            <li className="col-12 my-4">
              <button type="submit" className="btn btn-lg w-100 btn-info text-uppercase mb-2" title="">
                SIGN UP
              </button>
